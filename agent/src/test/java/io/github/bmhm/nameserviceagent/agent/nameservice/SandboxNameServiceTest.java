...
class SandboxNameServiceTest {

  private final SandboxDnsNameService dnsService = new SandboxDnsNameService(null);
  ...
  void testResolveTwitter() throws UnknownHostException {
    // given
    final String hostname = "something.rds.amazonaws.com";
